...
informujący klientów o zakończeniu pracy serwera - po wysłaniu takiego sygnału i odebraniu wiadomości 
STOP od wszystkich klientów serwer usuwa swoją kolejkę i kończy pracę. (kolejki klientów)
...
# Rozwiązanie tego zadania nie jest udostępnia pełnej funkcjonalności
